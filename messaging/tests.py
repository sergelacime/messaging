...
#         self.message = Message.objects.create(sender=self.user, recipient=self.user, subject='Test', body='Test body')
...
#         self.assertEqual(edited_message.subject, 'Modified Test')
